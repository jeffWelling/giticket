...
func deleteTicket(ticketID int, branchName string, debugFlag bool) (bool, error) {
	...
	giticketTicketsTreeBuilder.Remove(theTicket.TicketFilename())
	...
	giticketTreeBuilder.Insert("tickets", newGiticketTicketsTreeID, git.FilemodeTree)
	...
	rootTreeBuilder.Insert(".giticket", newGiticketTreeID, git.FilemodeTree)
